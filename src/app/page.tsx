    ...
    try {
      if (isLogin) {
        ...
        if (authData.user) {
          ...
          // 🔥 EL TOQUE MÁGICO: Obliga al servidor a recargar las cookies antes de saltar de página
          router.refresh();
          // 🔥 AHORA TE MANDA A '/inicio'
          router.push('/inicio');
        }
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 font-sans p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        {/* 🔥 CABECERA CON LOGO IMPONENTE 🔥 */}
        <div className="bg-slate-50 py-12 px-8 text-center border-b border-slate-100 relative flex flex-col items-center">
