...
export default async function GymnastsPage() {
  ...
  return <div className="min-h-screen bg-slate-50 p-4 md:p-8">
    ...
    <main className="mx-auto max-w-7xl">
      <div className="mb-5 flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-500 shadow-sm"><Search className="h-4 w-4" /> {gymnasts.length} gimnastas activas</div>
      {gymnasts.length===0?<div className="rounded-2xl border-2 border-dashed border-slate-200 bg-white p-14 text-center text-slate-500">No hay gimnastas registradas en esta organización.</div>:
